...
public class cg_autonBlueOverBump extends SequentialCommandGroup {
  ...
  public cg_autonBlueOverBump(DriveSubsystem drive, StoveSubsystem stove, FiveSecondRuleSubsystem fsr, VisionSubsystem vision) {
    m_drive = drive;
    m_stove = stove;
    m_fsr = fsr;
    m_vision = vision;
    ...
    addCommands(
        ...
        new cg_Wait(0.5),
        new cg_OverBump(m_drive, m_vision, false), 
