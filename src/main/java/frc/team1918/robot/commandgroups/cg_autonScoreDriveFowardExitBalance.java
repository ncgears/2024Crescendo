...
public class cg_autonScoreDriveFowardExitBalance extends SequentialCommandGroup {
  ...
  public cg_autonScoreDriveFowardExitBalance(DriveSubsystem drive, GyroSubsystem gyro, StoveSubsystem stove, FiveSecondRuleSubsystem fsr, VisionSubsystem vision) {
    m_drive = drive;
    m_gyro = gyro;
    m_stove = stove;
    m_fsr = fsr;
    ...
    addCommands(
        ...
        new helpers_debugMessage("Auton: ### Score, Drive Forward, 2 Point Exit, Balance ###"),
