...
public class cg_DriveForward3p6m extends SequentialCommandGroup {
  ...
  public cg_DriveForward3p6m(DriveSubsystem drive, GyroSubsystem gyro, VisionSubsystem vision) {
    m_drive = drive;
    m_gyro = gyro;
    m_vision = vision;
    ...
    addCommands(
        ...
        new drive_followTrajectory(m_drive, m_gyro, new ThreeSixMetersForward()), 
