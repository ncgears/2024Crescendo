...
public class cg_DriveBackward3m extends SequentialCommandGroup {
  private final DriveSubsystem m_drive;
  private final GyroSubsystem m_gyro;
  private final VisionSubsystem m_vision;

  public cg_DriveBackward3m(DriveSubsystem drive, GyroSubsystem gyro, VisionSubsystem vision) {
    m_drive = drive;
    m_gyro = gyro;
    m_vision = vision;
    ...
    addCommands(
        ...
        new helpers_debugMessage("Drive: Follow trajectory 'ThreeMetersBackward'"),
        new drive_followTrajectory(m_drive, m_gyro, new ThreeMetersBackward()), 
