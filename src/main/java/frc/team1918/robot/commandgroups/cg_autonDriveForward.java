...
public class cg_autonDriveForward extends SequentialCommandGroup {
  ...
  public cg_autonDriveForward(DriveSubsystem drive, GyroSubsystem gyro, StoveSubsystem stove, FiveSecondRuleSubsystem fsr, VisionSubsystem vision) {
    m_drive = drive;
    m_gyro = gyro;
    m_stove = stove;
    m_fsr = fsr;
    ...
    addCommands(
        ...
        new cg_Wait(0.5),
        new cg_DriveForward4m(m_drive, m_gyro, m_vision), 
