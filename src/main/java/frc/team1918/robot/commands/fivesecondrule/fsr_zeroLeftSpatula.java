...
public class fsr_zeroLeftSpatula extends Command {
  ...
  public void end(boolean interrupted) {
    ...
    // if(m_fsr.getSpatulaRevLimit(spatulas.LEFT)) m_fsr.setSpatulaZeroPos(spatulas.LEFT);
    m_fsr.setSpatulaZeroPos(spatulas.LEFT);
